    ...
    ?>
      ...
      <div class="content1 relative isolate overflow-hidden py-16 sm:py-24 lg:py-40">
        ...
        <div class="relative z-10">
          <h2 class="text-3xl font-bold tracking-tight text-black sm:text-7xl fm-f">รายการอสังหาริมทรัพย์ทั้งหมด
          </h2>
     
          <p class="mt-4 text-lg leading-8 text-black sm:text-4xl fm-f ">คุณสามารถเลือกได้เลย !</p>
        </div>
      </div>
...
<div class="content2 mx-auto my-10">
    <div class="container-fluid">
        <p class="text-5xl text-center fm-f font-semibold">คอนโด</p>
        <div class="container mx-auto my-20">
            <div class="grid grid-cols-3 gap-6"> 
                <?php
                  if ($rows_condo > 0) {
                    while ($product_condo = $query_condo->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '            <div class="flex items-center justify-between mb-4">';
                        echo '                <p>ราคา : </p>';
                        echo '                <span class="text-2xl font-bold text-indigo-600">' . htmlspecialchars(number_format($product_condo['price'])) . '</span>';
                        echo '                <div class="flex items-center">';
                        echo '                    <p>จำนวนห้อง : </p>';
