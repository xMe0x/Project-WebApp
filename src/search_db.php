...
<div class="content2 mx-auto my-10">
    ...
    if ($results) {
        foreach ($results as $row) {
            ...
            echo '                <p>ราคา : </p>';
            echo '                <span class="text-2xl font-bold text-indigo-600">' . htmlspecialchars(number_format($row['price'])) . '</span>';
        ...
        echo "<script>alert('ไม่พบข้อมูลที่ค้นหาในระบบ'); window.location.href = 'index.php';</script>";
      }
      ?>
        </div>
    </div>
